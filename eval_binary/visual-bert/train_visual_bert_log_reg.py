...
def train_visual_bert():
    ...
    with open(gc_path, newline='') as gcf:
        ...
        vbert = tr.VisualBertModel.from_pretrained('uclanlp/visualbert-vcr-coco-pre')
        vbert.to('cuda')
            ...
            for add in ["", "_cap"]:
                ...
                for pair in tqdm(data):
                    ...
                    for sent in pair[0]:
                        ...
                        inputs.to('cuda')
                        outputs = vbert(**inputs, visual_embeds=visual_embeds, visual_attention_mask=visual_attention_mask)
